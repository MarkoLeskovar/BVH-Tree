...
from bvhtree.mesh import box_triangle_intersection
...
def main():
    ...
    for i in range(num_triangles):
        ...
        does_intersect[i] = box_triangle_intersection(aabb.min, aabb.max, tri_vertices[0, :], tri_vertices[1, :], tri_vertices[2, :])
