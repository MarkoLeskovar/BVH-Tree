...
def main():
    ...
    def sphere_widget_callback(point):
        ...
        # Node list
        node_list = AABBNodeList()
        # Node stack
        node_stack = AABBNodeList()
        ...
        pyvista_mesh_nodes = node_list.to_pyvista_lines()
        ...
        pl.add_mesh(intersecting_leaf_nodes.to_pyvista_lines(), name='nodes_2', color='black', line_width=5)


    # Add sphere widget
    pl.add_sphere_widget(sphere_widget_callback, center=init_point, color='darkorange', selected_color='orange', radius=0.01 * mesh_size,
